...
<script>
	...
	function sucFuncJson(d){
		...
		만약 json으로 지정하는 경우 JSON.parse()메소드를 사용할 필요 없음
		*/
...
<body>
	<div class="container">
	<div class="row">
		<a href="../NaverSearchAPI.do?keyword=$('#keyword').val(),&startNum=$('#startNum option:selected').val()">
			네이버검색정보JSON바로가기
		</a>
	</div>
